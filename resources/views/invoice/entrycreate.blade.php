...
@section('content')
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper" style="margin-left: 0px">
            ...
            <div class="form-layout form-layout-1" style="margin-left: -20px">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <form id="invoiceEntryForm" action="{{ }}" method="post">
                            @csrf
                            <table class="table table-bordered table-colored table-dark" id="memo">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td id="amount">
                                            <input  required class="form-control" type="number" min="1" id="amount" name="amount" value="{{old('amount')}}" placeholder="Amount">
                                        </td>
                                    </tr>
                    ...
                    <div class="col-lg-8" style="margin-left:-0px">
                        ...
                        <div class="container">
                            <div class="row">
                                <table class="table table-bordered table-colored table-dark">
                                    ...
                                    <tr>
                                        ...
                                        <th class="wd-35p">Invoice Entry</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <th scope="row">{{ ++$i}}</th>
                                            <td id="name_medicine">{{ $value->name }}</td>
                                            
                                            
                                            <td>{{ $value->price }}</td>
                                            <td >
                                                <a class="cart_quantity_delete"
                                                   href="{{ route('invoice.entry.delete',$value->rowId) }}"><i
                                                        class=" pl-5 fa fa-trash"></i>
                                                </a>
                                            </td>
                                        </tr>
                            ...
                            <div id="memoSaveInvoice">
                                <div class="row">
                                    <div>
                                        <h6 style="color:black">Total :{{Cart::total()}} <span>tk</span></h6>
                                    </div>
                                </div>
                                <br>
    ...
    @endsection
        ...
        <script type="text/javascript">
            ...
            $('invoiceEntryForm').on('submit', function(event){
                event.preventDefault();
                $.ajax({
                    url:'{{ route('invoice.entry.add') }}',
                    method:'post',
                    data:$(this).serialize(),
                    dataType:'json',
